...
<body>
    <div class="log-w3">
        <div class="w3layouts-main">
            ...
            ?>
            <form action="{{URL::to('/take-order')}}" method="post">
                {{csrf_field()}}
                <input type="text" class="ggg" name="shipper_email" placeholder="Nhập Email" required="">
                <input type="password" class="ggg" name="shipper_password" placeholder="Nhập Mật Khẩu" required="">
